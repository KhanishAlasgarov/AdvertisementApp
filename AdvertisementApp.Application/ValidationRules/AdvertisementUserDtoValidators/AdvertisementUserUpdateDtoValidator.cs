...
{
    public class AdvertisementUserUpdateDtoValidator : AbstractValidator<AdvertisementUserUpdateDto>
    {
        public AdvertisementUserUpdateDtoValidator()
        {
            ...
            //RuleFor(x => x.CvPath).NotEmpty().WithMessage("Add CV!");
        }
